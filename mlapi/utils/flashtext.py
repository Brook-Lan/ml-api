"""
源代码位置：<https://github.com/vi3k6i5/flashtext>
不过该工具只适合有空格分隔的英文，对没有分词的中文不友好，有时有些关键字在匹配时会漏掉，根据
issue <https://github.com/vi3k6i5/flashtext/issues/43#issuecomment-423383233> 对代码做了更改，
经测试，可以解决中文匹配问题
"""
import os
import string
                ...
                if self._keyword in current_dict or char in current_dict:
                    ...
                    if char in current_dict:
                        ...
                        if is_longer_seq_found:
                            idx = sequence_end_pos -1    # 添加 -1 是为了适用中文
                    current_dict = self.keyword_trie_dict
